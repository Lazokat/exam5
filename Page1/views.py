...
def viewss(request):
    ...
    if request.method == "POST":
        messages.success(request, f"{Products.title} added to your cart.")
...
#         return redirect("shop:add_to_cart", id=product_id)
#
#     context = {
#         "products": product,
#     }
...
def product_detail(request, pk):
    ...
    if request.method == "POST":
        messages.success(request, f"{product.name} added to your cart.")
        return redirect("shop:add_to_cart", product_id=pk)
